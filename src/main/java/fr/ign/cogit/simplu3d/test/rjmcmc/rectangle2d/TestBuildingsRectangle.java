...
public class TestBuildingsRectangle<O, C extends Configuration<O>, S extends Sampler<O, C, SimpleTemperature>, V extends Visitor<O, C, SimpleTemperature, S>> {
  ...
  public static Configuration<Rectangle2D> create_configuration(Parameters p,
      Geometry bpu) {
    ...
    UnaryEnergy<Rectangle2D> u1 = new IntersectionAreaUnaryEnergy<Rectangle2D>(
        bpu);
    ...
    UnaryEnergy<Rectangle2D> u4 = new DifferenceAreaUnaryEnergy<Rectangle2D>(
        bpu);
  ...
  static Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature> create_sampler(
      Parameters p, IEnvelope r) {
    ...
    ObjectBuilder<Rectangle2D> builder = new ObjectBuilder<Rectangle2D>() {
      ...
      public Rectangle2D build(double[] coordinates) {
        return new Rectangle2D(coordinates[0], coordinates[1], coordinates[2],
    ...
    Vector2D n = v.negate();
    UniformBirth<Rectangle2D, Configuration<Rectangle2D>, Modification<Rectangle2D, Configuration<Rectangle2D>>> birth = new UniformBirth<Rectangle2D, Configuration<Rectangle2D>, Modification<Rectangle2D, Configuration<Rectangle2D>>>(
        new Rectangle2D(r.minX(), r.minY(), n.x(), n.y(), minratio),
        new Rectangle2D(r.maxX(), r.maxY(), v.x(), v.y(), maxratio), builder);

    PoissonDistribution distribution = new PoissonDistribution(
        Double.parseDouble(p.get("poisson")));

    DirectSampler<Rectangle2D, Configuration<Rectangle2D>, PoissonDistribution, UniformBirth<Rectangle2D, Configuration<Rectangle2D>, Modification<Rectangle2D, Configuration<Rectangle2D>>>> ds = new DirectSampler<Rectangle2D, Configuration<Rectangle2D>, PoissonDistribution, UniformBirth<Rectangle2D, Configuration<Rectangle2D>, Modification<Rectangle2D, Configuration<Rectangle2D>>>>(
        distribution, birth);

    List<Kernel<Rectangle2D, Configuration<Rectangle2D>, Modification<Rectangle2D, Configuration<Rectangle2D>>>> kernels = new ArrayList<Kernel<Rectangle2D, Configuration<Rectangle2D>, Modification<Rectangle2D, Configuration<Rectangle2D>>>>(
        3);
  ...
  public static void main(String[] args) throws Exception {
    ...
    Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature> samp = create_sampler(
        p, geom.getEnvelope());
    Schedule<SimpleTemperature> sch = create_schedule(p);
    EndTest<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>> end = create_end_test(p);

    Visitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>> visitor = new OutputStreamVisitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>>(
        System.out);
    Visitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>> shpVisitor = new ShapefileVisitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>>(
        "result");
    List<Visitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>>> list = new ArrayList<Visitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>>>();
    list.add(visitor);
    list.add(shpVisitor);
    CompositeVisitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>> mVisitor = new CompositeVisitor<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>>(
        list);
  ...
  private static EndTest<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>> create_end_test(
      Parameters p) {
    return new MaxIterationEndTest<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature, Sampler<Rectangle2D, Configuration<Rectangle2D>, SimpleTemperature>>(
