...
/**
 * A specific graph configuration. It can be used in a DirectRejection approach or in a
 * RejectionSampler approach.
 * @author JPerret
 * @param <T>
 */
public class ModelInstanceGraphConfiguration<T extends AbstractBuilding> extends
  ...
  public ModelInstanceGraphConfiguration(BasicPropertyUnit bPU, IModelInstance mI,
      UnaryEnergy<T> unary_energy, BinaryEnergy<T, T> binary_energy) {
