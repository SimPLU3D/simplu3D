...
import fr.ign.cogit.simplu3d.test.rjmcmc.cuboid.configuration.GraphConfigurationPredicate;
import fr.ign.cogit.simplu3d.test.rjmcmc.cuboid.configuration.GraphConfigurationWithPredicate;
...
public class OCLBuildingsCuboidFinalWithPredicate {
  ...
  public Configuration<Cuboid2> process(BasicPropertyUnit bpu, Parameters p, Environnement env,
    ...
    Sampler<Cuboid2> samp = create_sampler(p, bpu);
    // Température
  ...
  public static Configuration<Cuboid2> create_configuration(Parameters p, Geometry geom,
    ...
    GraphConfigurationPredicate<Cuboid2> pred = new GraphConfigurationPredicate<Cuboid2>(bpu);
    Configuration<Cuboid2> conf = new GraphConfigurationWithPredicate<Cuboid2>(bpu, pred,
  ...
  static Sampler<Cuboid2> create_sampler(Parameters p, BasicPropertyUnit bpU) {
    ...
    DirectSampler<Cuboid2> ds = new DirectSampler<Cuboid2>(distribution, birth);
...
//  }
  ...
  private EndTest<Cuboid2> create_end_test_stability(Parameters p) {
    ...
    return new StabilityEndTest<Cuboid2>(p.getInteger("nbiter"), loc_deltaconf);
  }
