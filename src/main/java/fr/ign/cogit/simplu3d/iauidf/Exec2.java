...
public class Exec2 {
    ...
    public final static String folder = "/media/mickael/Data/mbrasebin/donnees/IAUIDF/IMU_ee/";
    ...
    public static boolean simulRegulationByIMU(int imu, String folderImu)
        ...
        IFeatureCollection<IFeature> featParcel = ShapefileReader
                .read(folder + NAME_FILE_PARCE);
        ...
        for (IFeature feat : featParcel) {
            ...
            BasicPropertyUnit bPU = retrieveBPU(feat, env);
            ...
            if (r1 != null && r1.getArt_71() == 2
                ...
                featC1.addAll(simulRegulationByBasicPropertyUnit(env, bPU,  imu,
                        r1, r2));
                ...
                featC2.addAll(simulRegulationByBasicPropertyUnit(env, bPU,  imu,
                        r1, r2));
                ...
                featC.addAll(simulRegulationByBasicPropertyUnit(env, bPU,  imu,
                        r1, r2));
    ...
    private static BasicPropertyUnit retrieveBPU(IFeature feat,
            Environnement env) {
    ...
    private static IFeatureCollection<IFeature> fusionne(
        ...
        while (!(featC1.isEmpty()) && !featC2.isEmpty()) {
            ...
            for (IFeature feat : lF1) {
                contrib1 = contrib1 + feat.getGeom().area() * Double
                        .parseDouble(feat.getAttribute("Hauteur").toString());
            }

            double contrib2 = 0;
            for (IFeature feat : lF2) {
                contrib2 = contrib2 + feat.getGeom().area() * Double
                        .parseDouble(feat.getAttribute("Hauteur").toString());
            }
    ...
    private static boolean initiateSimulationParamters(Regulation r1,
        ...
        if (r2 != null) {
            ...
            p.set("maxlen", Math.min(p.getDouble("maxlen"),
                    Math.max(longueur1, longueur2)));

            p.set("maxwid", Math.min(p.getDouble("maxwid"),
                    Math.max(longueur1, longueur2)));
