...
public class BandProduction {
	...
	public static List<IMultiSurface<IOrientableSurface>> getBands(
		 ...
		 * 
		 * // On enlève la bande de x m à partir de la voirie int r1_art6 =
		 * r1.getArt_6(); if (r1_art6 != 88 && r1_art6 != 99 && r1_art6 != 0 &&
		 * !iMSBande1.isEmpty()) {
		 * 
		 * iMSBande1 = FromGeomToSurface.convertMSGeom(iMSBande1
		 * .difference(iMSRoad.buffer(r1_art6))); }
		 * 
		 * // idem pour r2 int r2_art6 = r2.getArt_6(); if (r2_art6 != 88 &&
		 * r2_art6 != 99 && r2_art6 != 0 && iMSBande2 != null &&
		 * !iMSBande2.isEmpty()) {
		 * 
		 ...
		 * réglementé // ART_73 Distance minimale des constructions par rapport
		 * à la limte // séparative de fond de parcelle 88= non renseignable,
		 * 99= non // réglementé
		 * 
		 ...
		 * .getCadastralParcel().get(0).getSubParcel().get(0) .getBorduresLat();
		 ...
		 * .getCadastralParcel().get(0).getSubParcel().get(0)
		 * .getBorduresFond(); for (SpecificCadastralBoundary sc : lBordureFond)
		 * { iMSLim.add((IOrientableCurve) sc.getGeom()); }
		 * 
		 * // On enlève la bande de x m à partir des limites séparatives int
		 * r1_art72 = r1.getArt_72(); if (r1_art72 != 88 && r1_art72 != 99 &&
		 * r1_art72 != 0 && !iMSBande1.isEmpty()) {
		 * 
		 * iMSBande1 = FromGeomToSurface.convertMSGeom(iMSBande1
		 * .difference(iMSLim.buffer(r1_art72))); }
		 * 
		 * // idem pour r2 int r2_art72 = r2.getArt_72(); if (r2_art72 != 88 &&
		 * r2_art72 != 99 && r2_art72 != 0 && iMSBande2 != null &&
		 * !iMSBande2.isEmpty()) {
		 * 
		 * iMSBande2 = FromGeomToSurface.convertMSGeom(iMSBande2
