...
public class LoaderSHP {
  ...
  public static Environnement load(String folder) throws CloneNotSupportedException {
    ...
    IFeatureCollection<Alignement> alignementColl = AlignementImporter.importRecul(prescriptions,
        parcelles);
