 ...
 * @version 1.0
 **/
public class OBCFDRConstraintOptimisation  extends DefaultSimPLU3DOptimizer<Cuboid> {


  public GraphConfiguration<Cuboid> process(BasicPropertyUnit bpu, Parameters p, Environnement env, int id,
      ConfigurationModificationPredicate<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> pred, double distReculVoirie,
    ...
    Sampler<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> samp = create_sampler(Random.random(), p, bpu, pred);
    // Température
    ...
    if (p.getBoolean("statsvisitor")) {
      StatsVisitor<Cuboid, GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> statsViewer = new StatsVisitor<>("Énergie");
    ...
    if (p.getBoolean("csvvisitor")) {
      ...
      CSVvisitor<Cuboid, GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> statsViewer = new CSVvisitor<>(fileName);
      list.add(statsViewer);
    }
  ...
  public GraphConfiguration<Cuboid> create_configuration(Parameters p, IGeometry geom, BasicPropertyUnit bpu, double distReculVoirie,
      double slope, double hIni, double hMax, double distReculLimi, double slopeProspect, double maximalCES) throws Exception {
   ...
   *         prise en compte
   */
  public GraphConfiguration<Cuboid> create_configuration(Parameters p, Geometry geom, BasicPropertyUnit bpu, double distReculVoirie,
      double slope, double hIni, double hMax, double distReculLimi, double slopeProspect, double maximalCES) {
    ...
    ConstantEnergy<Cuboid, Cuboid> ponderationC1 = new ConstantEnergy<Cuboid, Cuboid>(p.getDouble("ponderation_c1"));
    ...
    ConstantEnergy<Cuboid, Cuboid> ponderationC2 = new ConstantEnergy<Cuboid, Cuboid>(p.getDouble("ponderation_c2"));
    ...
    ConstantEnergy<Cuboid, Cuboid> ponderationC3 = new ConstantEnergy<Cuboid, Cuboid>(p.getDouble("ponderation_c3"));
    ...
    ConstantEnergy<Cuboid, Cuboid> ponderationC4 = new ConstantEnergy<Cuboid, Cuboid>(p.getDouble("ponderation_c4"));
    ...
    ConstantEnergy<Cuboid, Cuboid> ponderationC5 = new ConstantEnergy<Cuboid, Cuboid>(p.getDouble("ponderation_c5"));
   ...
   * @return
   */
  public Sampler<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> create_sampler(RandomGenerator rng, Parameters p,
    ...
    UniformBirth<Cuboid> birth = new UniformBirth<Cuboid>(rng, new Cuboid(env.minX(), env.minY(), minlen, minwid, minheight, 0),
        new Cuboid(env.maxX(), env.maxY(), maxlen, maxwid, maxheight, Math.PI), builder, TransformToSurface.class, samplingSurface);

    // Distribution de poisson
    PoissonDistribution distribution = new PoissonDistribution(rng, p.getDouble("poisson"));

    DirectSampler<Cuboid, GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> ds = new DirectRejectionSampler<>(distribution, birth,
        pred);
