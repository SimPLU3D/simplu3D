...
public class EPFIFTask {
  ...
  public static String run(File folder, String dirName, File folderOut,
    ...
    Map<String, List<Regulation>> regulation = loadRules(
        new File(folder + "/" + PARCEL_NAME), Integer.parseInt(imu));
    ...
    for (BasicPropertyUnit bPU : env.getBpU()) {
      ...
      if (bPU.getArea() > MAX_PARCEL_AREA) {
        result += imu + " ; " + id + " ; " + (CODE_PARCEL_TOO_BIG) + " ; "
            + (CODE_PARCEL_TOO_BIG) + "\n";
        continue;
      }
    ...
    if (idparWithNoRules.size() > 0) {
      for (String id : idparWithNoRules)
        result += imu + " ; " + id + " ; " + (CODE_PARCEL_NO_RULE) + " ; "
            + (CODE_PARCEL_NO_RULE) + "\n";
    ...
    if (idsimulationNotRunnable.size() > 0) {
      for (String id : idsimulationNotRunnable) {
        ...
        System.out
            .println(id + "  " + imu + "   " + CODE_SIMULATION_NOT_RUNNABLE);
  ...
  private static Map<String, List<Regulation>> loadRules(File parcelle,
    ...
    for (IFeature feat : featC) {
      ...
      double art_10 = Double.parseDouble(
          feat.getAttribute(ParcelAttributeTransfert.att_art_10).toString());
      double art_10_m = Double.parseDouble(
          feat.getAttribute(ParcelAttributeTransfert.att_art_10_m).toString());
      ...
      Regulation r = new Regulation(code_imu, libelle_zone, insee,
          ...
          art_71, art_72, art_73, art_74, art_8, art_9, art_10_top, art_10,
      ...
      if (bande != 0) {
        ...
        int art_10_top_2 = Integer.parseInt(
            feat.getAttribute(ParcelAttributeTransfert.att_art_10_top_2)
                .toString());
        double art_10_2 = Double.parseDouble(feat
            .getAttribute(ParcelAttributeTransfert.att_art_10_2).toString()); // ATTENTION
        // A
        // CHANGER
        double art_10_m_2 = Double.parseDouble(feat
            .getAttribute(ParcelAttributeTransfert.att_art_10_m_2).toString());
        ...
        Regulation r2 = new Regulation(code_imu, libelle_zone, insee,
            ...
            art_9_2, art_10_top_2, art_10_2, art_10_m_2, art_12_2, art_13_2,
            art_14_2);
