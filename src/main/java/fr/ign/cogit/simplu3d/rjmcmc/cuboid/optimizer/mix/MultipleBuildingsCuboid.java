...
public class MultipleBuildingsCuboid extends BasicCuboidOptimizer<Cuboid> {
  ...
  public GraphConfiguration<Cuboid> process(BasicPropertyUnit bpu, Parameters p,
    ...
    System.out
        .println("*************** " + end.getClass() + " ********************");

    PrepareVisitors<Cuboid> pv = new PrepareVisitors<>(env);
    CompositeVisitor<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> mVisitor = pv
        .prepare(p, bpu.getId());
    /*
  ...
  private GraphConfiguration<Cuboid> create_configuration_intersection(
  ...
  private GraphConfiguration<Cuboid> create_configuration_no_inter(Parameters p,
      Geometry geom, BasicPropertyUnit bpu) {
    // Énergie constante : à la création d'un nouvel objet
  ...
  public static Sampler<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> create_sampler(
    ...
    MixCuboidSampler objectSampler = new MixCuboidSampler(rng, p_simple,
        transformBand1, transformBand2, builderBand1, builderBand2, c1, c2);
  ...
  private static List<Kernel<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>>> getBande1Kernels(
      ...
      Parameters p, Transform transform, ObjectBuilder<Cuboid> pbuilder,
      boolean parallel) {
    List<Kernel<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>>> kernels = new ArrayList<>();
    // Kernel de naissance
    ...
    if (parallel) {
      ...
      Kernel<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> simpleRotatekernel = new Kernel<>(
          pView, pView, variate, variate,
          new RotateCuboid(p.getDouble("amplitudeRotate") * Math.PI / 180), 0.2,
          1.0, "RotateS");
      ...
      if ((p.getDouble("maxheight") - p.getDouble("minheight")) > 0.2) {
        ...
        Kernel<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> simpleHeight = new Kernel<>(
            pView, pView, variate, variate, new ChangeHeight(amplitudeHeight),
            0.2, 1.0, "ChgHeightS");
  ...
  private static List<Kernel<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>>> getBande2Kernels(
      Variate variate,
      NullView<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> nullView,
      Parameters p, Transform transformSimple, ObjectBuilder<Cuboid> sbuilder,
      boolean parallel) {
    ...
    if (parallel) {
      ...
      Kernel<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> kernel2 = new Kernel<>(
          ...
          p.getDouble("pbirthdeath"), p.getDouble("pbirth"), "Parallel2");
      kernels.add(kernel2);
      ...
      if ((p.getDouble("maxheight") - p.getDouble("minheight")) > 0.2) {
        ...
        double amplitudeHeight = p.getDouble("amplitudeHeight");
        Kernel<GraphConfiguration<Cuboid>, BirthDeathModification<Cuboid>> simpleHeight = new Kernel<>(
            sView, sView, variate, variate, new ChangeHeight(amplitudeHeight),
            0.2, 1.0, "ChgHeightS");
        kernels.add(simpleHeight);
      }
