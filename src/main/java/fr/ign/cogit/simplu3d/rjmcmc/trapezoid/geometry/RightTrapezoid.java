 ...
 * @version 1.0
 **/
public class RightTrapezoid extends AbstractSimpleBuilding implements Primitive {
	 ...
	 */
	public RightTrapezoid(double centerx, double centery, double length1, double length2,  double length3, double width, double height,
			double orientation) {
		super();
		this.isNew = true;
	...
	public Object[] getArray() {
		return new Object[] { this.centerx, this.centery, this.length1, this.length2, this.length3, this.width, this.height,
				this.orientation };
	}
	...
	public double[] toArray() {
		return new double[] { this.centerx, this.centery, this.length1, this.length2, this.length3,this.width, this.height,
				this.orientation };
	}
