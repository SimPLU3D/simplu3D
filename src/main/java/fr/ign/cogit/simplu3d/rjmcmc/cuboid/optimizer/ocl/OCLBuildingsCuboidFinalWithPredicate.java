...
public class OCLBuildingsCuboidFinalWithPredicate {
  ...
  public Configuration<Cuboid> process(BasicPropertyUnit bpu, Parameters p, Environnement env,
    ...
    Sampler<Cuboid> samp = create_sampler(Random.random(), p, bpu);
    // Température
  ...
  public static Configuration<Cuboid> create_configuration(Parameters p, Geometry geom,
    ...
    GraphConfigurationPredicate<Cuboid> pred = new GraphConfigurationPredicate<Cuboid>(bpu);
    Configuration<Cuboid> conf = new GraphConfigurationWithPredicate<Cuboid>(bpu, pred,
  ...
  static Sampler<Cuboid> create_sampler(RandomGenerator rng,Parameters p, BasicPropertyUnit bpU) {
    ...
    UniformBirth<Cuboid> birth = new UniformBirth<Cuboid>(rng,new Cuboid(env.minX(), env.minY(),
    ...
    kernels.add(Kernel.make_uniform_modification_kernel(rng,builder, new MoveCuboid(amplitudeMove),
        0.2, "Move"));
    ...
    kernels.add(Kernel.make_uniform_modification_kernel(rng,builder, new ChangeWidth(amplitudeMaxDim),
        0.2, "ChgWidth"));
    kernels.add(Kernel.make_uniform_modification_kernel(rng,builder, new ChangeLength(amplitudeMaxDim),
        0.2, "ChgLength"));
    double amplitudeHeight = p.getDouble("amplitudeHeight");
    kernels.add(Kernel.make_uniform_modification_kernel(rng,builder, new ChangeHeight(amplitudeHeight),
        0.2, "ChgHeight"));
