...
public class SamplePredicate2<O extends Cuboid, C extends AbstractGraphConfiguration<O, C, M>, M extends AbstractBirthDeathModification<O, C, M>>
 ...
 * @throws Exception 
   */
  public SamplePredicate2(BasicPropertyUnit currentBPU, double distReculVoirie,
 ...
 * @throws Exception 
   */
  private SamplePredicate2(BasicPropertyUnit bPU) throws Exception {
    super();
    this.currentBPU = bPU;
