...
public class ParallelPolygonTransform implements Transform {
	 ...
	 * Logger.
	 */
	static Logger LOGGER = LogManager.getLogger(ParallelPolygonTransform.class.getName());
	...
	public ParallelPolygonTransform(double[] d, double[] v, IGeometry polygon) throws Exception {
	...
	/**
	 * Indicate if the transform is valid (i.e: that the triangulation in the
	 * PolygonTransform is ok)
	 * 
	 * @return indicate if the transform is valid
	 */
