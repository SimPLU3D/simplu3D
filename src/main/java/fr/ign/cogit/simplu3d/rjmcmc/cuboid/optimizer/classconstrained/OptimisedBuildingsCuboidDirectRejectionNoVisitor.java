...
public class OptimisedBuildingsCuboidDirectRejectionNoVisitor {
  ...
  public Configuration<Cuboid> process(BasicPropertyUnit bpu, Parameters p,
      Environnement env, int id, ConfigurationModificationPredicate<Cuboid> pred) {
   ...
   *         prise en compte
   */
  public Configuration<Cuboid> create_configuration(Parameters p,
   ...
   * @return
   */
  Sampler<Cuboid> create_sampler(RandomGenerator rng, Parameters p,
      BasicPropertyUnit bpU, ConfigurationModificationPredicate<Cuboid> pred) {
    // Un vecteur ?????
    ...
    DirectSampler<Cuboid> ds = new DirectRejectionSampler<Cuboid>(distribution,
        birth, pred);
