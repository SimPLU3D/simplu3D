package fr.ign.cogit.simplu3d.rjmcmc.cuboid.transformation.parallelCuboid;
 ...
 * @version 1.0
 **/
public class MoveParallelCuboid implements Transform {

  private double amplitudeMove;

  public MoveParallelCuboid(double amplitudeMove) {
