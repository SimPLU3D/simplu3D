 ...
 *
 */
public class SimpleCuboidAbstractSimpleBuildingBuilder implements ObjectBuilder<AbstractSimpleBuilding> {
	@Override
	public int size() {
		return 6;
	}
	...
	public Cuboid build(double[] val1) {
		...
		return new SimpleCuboid(val1[0], val1[1], val1[2], val1[3], val1[4], val1[5]);
	}
