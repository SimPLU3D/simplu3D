...
public class RunBuildingProfile {
  ...
  public static void main(String[] args) {
	  ...
	  String folderIn = DemoEnvironmentProvider.class.getClassLoader().getResource("fr/ign/cogit/simplu3d/").getPath();
	  ...
	  for(IFeature feat: featCollRoad){
		  ...
		  //Roads geometries are set to zero as  the tested simulation has a 0 zInf
	  }
    ...
    Profile profile = new Profile(
        ...
        1, // minimal height of the profile (it may be calculated automatically)
        20, //  maximal height of the profile (it may be calculated automatically)
