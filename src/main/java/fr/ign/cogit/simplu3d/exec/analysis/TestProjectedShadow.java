...
import fr.ign.cogit.sig3d.calculation.CalculNormales;
import fr.ign.cogit.sig3d.calculation.raycasting.RayCasting;
import fr.ign.cogit.simplu3d.analysis.InverseProjection;
import fr.ign.cogit.simplu3d.analysis.ProjectedShadow;
...
public class TestProjectedShadow {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		String folder = "D:/Donnees/StrasbourgKIT/StrasbourgKIT/GTRU/Project1/";
		...
		IDirectPosition dp1 = new DirectPosition(xc - longueur / 2, yc
				- largeur / 2, z);
		IDirectPosition dp2 = new DirectPosition(xc + longueur / 2, yc
				- largeur / 2, z);
		IDirectPosition dp3 = new DirectPosition(xc + longueur / 2, yc
				+ largeur / 2, z);
		IDirectPosition dp4 = new DirectPosition(xc - longueur / 2, yc
				+ largeur / 2, z);
		...
		feat.setRepresentation(new TexturedSurface(
				feat,
				TextureManager
						.textureLoading("D:/Donnees/StrasbourgKIT/StrasbourgKIT/Texture/Env3D_86.png"),
				longueur, largeur));
		...
		//List<IOrientableCurve> lC = CalculNormales.getNormal(env.getBatiments(), 5);
		//lGeom.addAll(lC);
